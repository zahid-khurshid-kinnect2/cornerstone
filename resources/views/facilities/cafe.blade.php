...
@include('facilities.layouts.sidebar')
    ...
    <div class="col-sm-8 col-md-9">
        <div class="explore_post">
            <h3>Cafeteria</h3>
            <div class="image">
                <img class="img-responsive" src="{{asset('public/images/Cafe-.jpg')}}" alt="image">
            </div>
            <p>
                ...
                <p> We encourage children to eat slowly. Therefore time of thirty minutes is allotted for the lunch hour. We understand that a child can detect hunger and fullness better when they eat slowly. This gives their brain time to register fullness. A nutritious and interesting menu is designed by our nutritionist keeping in mind the health requirements of the students. Over consumption of sweetened drinks and sodas have been linked to increased rates of obesity in children, therefore these unhealthy drinks are not allowed in school, not even during special occasions. Students are encouraged to drink water the whole school day for water retention and muscle care.
